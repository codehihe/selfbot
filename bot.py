...
raj = commands.Bot(description='TERMINAL ON TOP',
                           command_prefix='.',
                           self_bot=True,
                           intents=intents)
status_task = None
...
@raj.command()
async def help(ctx):
    message = (f"# <a:8_crown:1280192309455224863> **curse.exe** <a:8_crown:1280192309455224863>\n\n <a:CM_Thunder:1281169548472483852>  **COMMON CMDS SECTION**<:SlashCommand:1281169550347341877> \n\n <a:rainbow_dot1:1280192291704668235> **Srv Clone** :- `.csrv <copy srv id> <target srv id>`\n <a:rainbow_dot1:1280192291704668235> **Check Promo** :- `.checkpromo <promolink>`\n <a:rainbow_dot1:1280192291704668235> **Afk** :- `.afk <reason>`\n <a:rainbow_dot1:1280192291704668235> **Remove Afk** :- `.unafk`\n <a:rainbow_dot1:1280192291704668235> **AutoRespond** :- `.addar <trigger> , <response>`\n <a:rainbow_dot1:1280192291704668235> **Remove Respond** :- `.removear <triger>`\n <a:rainbow_dot1:1280192291704668235> **AutoMsg** :- `.auto <time> true <chnl> <msg>`\n <a:rainbow_dot1:1280192291704668235> **Stop AutoMsg** :- `.stopauto <msg id>`\n <a:rainbow_dot1:1280192291704668235> **Status Rotator** :- `.start_rotation`\n <a:rainbow_dot1:1280192291704668235> **Stop Rotator** :- `.stop_rotation`\n <a:rainbow_dot1:1280192291704668235> **Spam Msg** :- `.spam <amount> <msg>`\n <a:rainbow_dot1:1280192291704668235> **Clear Msg** :- `.clear <amount>`\n\n <a:PD_AUTOBUY:1280193183317491755> **INR SECTION** <a:PD_AUTOBUY:1280193183317491755> \n\n <:upi:1281169551819542569> **upi Id** :- `.upi`\n <:upi:1281169551819542569> **Qr Code** :- `.qr`\n\n<a:LTC:1280192303545192499>  **LITECOIN (LTC) SECTION** <a:LTC:1280192303545192499> \n\n <a:LTC:1280192303545192499> **Send Ltc** :- `.send <addy> <amount>`\n <a:LTC:1280192303545192499> **Check Balance** :- `.bal <addy>`\n <a:LTC:1280192303545192499> **Check Mybal** :- `.mybal`\n <a:LTC:1280192303545192499> **Ltc Price In Usd** :- `.ltcprice`\n <a:LTC:1280192303545192499> **Ltc Addy** :- `.addy`\n\n <a:verified_shine:1281169554957012992>  **VOUCH SECTION** <a:verified_shine:1281169554957012992> \n\n <a:verified_shine:1281169554957012992> **Vouch** :- `.vouch <product for price>`\n <a:verified_shine:1281169554957012992> **Exch Vouch** :- `.exch `\n\n<a:rules:1281169770326265856> **CALCULATOR SECTION** <a:rules:1281169770326265856> \n\n <a:rules:1281169770326265856> **Calculate** :- `.math <equation>`\n <a:rules:1281169770326265856> **I2c** :- `.i2c <inr amount>`\n <a:rules:1281169770326265856> **C2i** :- `.c2i <crypto amount>`\n\n <a:PD_ONLINE:1281169556123160576> **STATUS SECTION** <a:PD_ONLINE:1281169556123160576> \n\n <a:PD_ONLINE:1281169556123160576> **Stream** :- `.stream <title>`\n <a:PD_ONLINE:1281169556123160576> **Play** :- `.play <title>`\n <a:PD_ONLINE:1281169556123160576> **Watch** :- `.watch <title>`\n <a:PD_ONLINE:1281169556123160576> **Listen** :- `.listen <title>`\n <a:PD_ONLINE:1281169556123160576> **Stop Activity** :- `.stopactivity`\n\n")
...
@raj.command()
async def addy(ctx):
    message = (f"<a:LTC:1280192303545192499>  **LTC ADDY**  <a:LTC:1280192303545192499> ")
    message2 = (f"{LTC}")
